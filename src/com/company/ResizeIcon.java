...
public class ResizeIcon extends ImageIcon {
     ...
     */
    public ResizeIcon(byte[] imageData) {
        super(imageData);
    }
     ...
     * @see ImageIcon#ImageIcon(byte[])
     */
    public ResizeIcon(byte[] imageData, boolean proportionate) {
        super(imageData);
     ...
     */
    public ResizeIcon(byte[] imageData, String description) {
     ...
     * @see ImageIcon#ImageIcon(byte[], java.lang.String)
     */
    public ResizeIcon(byte[] imageData, String description, boolean proportionate) {
        super(imageData, description);
        this.proportionate = proportionate;
    }
     ...
     * @see ImageIcon#ImageIcon(java.awt.Image)
     */
    public ResizeIcon(Image image, boolean proportionate) {
        super(image);
        this.proportionate = proportionate;
    }
     ...
     */
    public ResizeIcon(Image image, String description) {
     ...
     * @see ImageIcon#ImageIcon(java.awt.Image, java.lang.String)
     */
    public ResizeIcon(Image image, String description, boolean proportionate) {
        super(image, description);
        this.proportionate = proportionate;
    }
     ...
     * @see ImageIcon#ImageIcon(java.lang.String)
     */
    public ResizeIcon(String filename, boolean proportionate) {
        super(filename);
        this.proportionate = proportionate;
    }
     ...
     */
    public ResizeIcon(String filename, String description) {
     ...
     * @see ImageIcon#ImageIcon(java.awt.Image, java.lang.String)
     */
    public ResizeIcon(String filename, String description, boolean proportionate) {
        super(filename, description);
        this.proportionate = proportionate;
    }
     ...
     */
    public ResizeIcon(URL location) {
        super(location);
    }
     ...
     * @see ImageIcon#ImageIcon(java.net.URL)
     */
    public ResizeIcon(URL location, boolean proportionate) {
        super(location);
        this.proportionate = proportionate;
    }
     ...
     */
    public ResizeIcon(URL location, String description) {
     ...
     * @see ImageIcon#ImageIcon(java.net.URL, java.lang.String)
     */
    public ResizeIcon(URL location, String description, boolean proportionate) {
        super(location, description);
        this.proportionate = proportionate;
    }
